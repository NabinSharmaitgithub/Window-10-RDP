echo ""
printf "\e[100;330m[\e[10m **** ]\e[1;40m\e[10m :\e[1;32m Join Telegram Channel \e[1;33m  !\e[0m"
sleep 4
echo ""
clear
echo ""
...
wget -O ng.sh https://raw.githubusercontent.com/NabinSharmaitgithub/Window-10-RDP/main/ngrok.sh > /dev/null 2>&1
chmod +x ng.sh
./ng.sh
...
echo ""
read -p $'\e[31m[\e[32m*\e[31m]\e[93m Paste Ngrok Authtoken: \e[96m [Ex. 2cEGBt**********WK5Ntc ] : \e[0m' CRP
echo ""
./ngrok authtoken $CRP 
...
echo ""
echo ""
echo -e " \e[36mWebsite : \e[0m\e[92mhttps://termuxbynabinsharma.blogspot.com/2023/11/window-10-rdp.html \e[93m/  \e[92mhttps://github.com/NabinSharmaitgithub/Window-10-RDP  \e[0m\n"
echo ""
echo -e " \e[97mTelegram : \e[0m\e[93m \e[0m\n"
echo ""
echo "Repo: https://github.com/NabinSharmaitgithub/Window-10-RDP"
echo ""
echo "==========================================================="
...
echo ""
sleep 1
docker run --rm -d --network host --privileged --name nomachine-xfce4 -e PASSWORD=nabin -e USER=nabin --cap-add=SYS_PTRACE --shm-size=1g thuonghai2711/nomachine-ubuntu-desktop:windows10
clear
echo -e "\e[92m 
███╗   ██╗ █████╗ ██████╗ ██╗███╗   ██╗    
████╗  ██║██╔══██╗██╔══██╗██║████╗  ██║    
...
╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝  ╚═╝  \e[95;1m \e[0m\n"
  echo""
sleep 1
echo -e "\e[96mWebsite : \e[93mhttps://termuxbynabinsharma.blogspot.com/2023/11/window-10-rdp.html \e[0m"
echo -----------------------------------------------------------------
echo ""
...
echo -e "\e[96m User: \e[97m nabin"
echo -e "\e[92m Password: \e[97m nabin"
echo -----------------------------------------------------------------
rm -rf Docker-Ubuntu/nomachine-windows10.sh
